...
//import 'package:medibuddy/src/ui/'
import 'package:medibuddy/src/common/convert_time.dart';
import 'package:medibuddy/src/global_bloc.dart';
import 'package:medibuddy/src/models/errors.dart';
import 'package:medibuddy/src/models/medicine.dart';
import 'package:medibuddy/src/models/medicine_type.dart';
import 'package:medibuddy/src/ui/homepage/homepage.dart';
import 'package:medibuddy/src/ui/new_entry/new_entry_bloc.dart';
import 'package:medibuddy/src/ui/success_screen/success_screen.dart';
  ...
  Future<void> scheduleNotification(Medicine medicine) async {
    ...
    for (int i = 0; i < (24 / medicine.interval).floor(); i++) {
      ...
      await flutterLocalNotificationsPlugin.showDailyAtTime(
          ...
          'MediBuddy ',
          "It is time to take ${medicine.medicineName}, dosage ${medicine.dosage} mg",
          Time(hour, minute, 0),
